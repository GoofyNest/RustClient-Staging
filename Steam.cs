...
public class SteamInventoryGen : MonoBehaviour // TypeDefIndex: 11072
{
...
public class SteamDLCItem : ScriptableObject // TypeDefIndex: 12528
{
	public int id;
...
public class SteamInventoryCategory : ScriptableObject // TypeDefIndex: 12529
{
	[HeaderAttribute]
...
public enum SteamInventoryCategory.Price // TypeDefIndex: 12530
{
	public int value__;
...
public enum SteamInventoryCategory.DropChance // TypeDefIndex: 12531
{
	public int value__;
...
public class SteamInventoryItem : ScriptableObject // TypeDefIndex: 12532
{
	public int id;
	public Sprite icon;
...
public enum SteamInventoryItem.Category // TypeDefIndex: 12533
{
	public int value__;
...
public enum SteamInventoryItem.SubCategory // TypeDefIndex: 12534
{
	public int value__;
...
public class SteamClientWrapper : SingletonComponent<SteamClientWrapper> // TypeDefIndex: 12549
{
...
public enum SteamClientWrapper.RichPresenceState // TypeDefIndex: 12550
{
	public int value__;
...
public static class SteamNewsSource // TypeDefIndex: 12931
{
...
public struct SteamNewsSource.Story // TypeDefIndex: 12932
{
	public string name;
	public string url;
	public int date;
...
private sealed class SteamNewsSource.<GetStories>d__2 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 12933
{
	private int <>1__state;
...
public class SteamFriendsList : MonoBehaviour // TypeDefIndex: 13022
{
...
public class SteamFriendsList.onFriendSelectedEvent : UnityEvent<ulong, string> // TypeDefIndex: 13023
{
...
private sealed class SteamFriendsList.<>c__DisplayClass15_0 // TypeDefIndex: 13024
{
...
private sealed class SteamFriendsList.<>c__DisplayClass16_0 // TypeDefIndex: 13025
{
	public IPlayerInfo f;
...
private sealed class SteamFriendsList.<>c__DisplayClass17_0 // TypeDefIndex: 13026
{
	public string name;
...
private sealed class SteamFriendsList.<>c__DisplayClass18_0 // TypeDefIndex: 13027
{
...
private sealed class SteamFriendsList.<>c__DisplayClass18_1 // TypeDefIndex: 13028
{
...
private sealed class SteamFriendsList.<>c // TypeDefIndex: 13029
{
...
public class SteamUserButton : MonoBehaviour // TypeDefIndex: 13030
{
...
private struct SteamUserButton.<UpdateFromUser>d__14 : IAsyncStateMachine // TypeDefIndex: 13031
{
	public int <>1__state;
	public AsyncVoidMethodBuilder <>t__builder;
...
public class Steam // TypeDefIndex: 13777
{
...
private sealed class Steam.<>c // TypeDefIndex: 13778
{
...
public class SteamInventoryCrafting : MonoBehaviour // TypeDefIndex: 13874
{
...
public class SteamInventoryCrafting.MarketPrice // TypeDefIndex: 13875
{
	[CompilerGeneratedAttribute]
...
private sealed class SteamInventoryCrafting.<>c__DisplayClass20_0 // TypeDefIndex: 13876
{
...
private sealed class SteamInventoryCrafting.<>c // TypeDefIndex: 13877
{
...
private sealed class SteamInventoryCrafting.<>c__DisplayClass23_0 // TypeDefIndex: 13878
{
...
private struct SteamInventoryCrafting.<GetMarketPrice>d__29 : IAsyncStateMachine // TypeDefIndex: 13879
{
	public int <>1__state;
...
private struct SteamInventoryCrafting.<GetMarketPriceImpl>d__30 : IAsyncStateMachine // TypeDefIndex: 13880
{
	public int <>1__state;
	public AsyncTaskMethodBuilder<SteamInventoryCrafting.MarketPrice> <>t__builder;
	public IPlayerItemDefinition definition;
...
private sealed class SteamInventoryCrafting.<>c__DisplayClass31_0 // TypeDefIndex: 13881
{
...
private sealed class SteamInventoryCrafting.<LoadMarketPrice>d__31 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 13882
{
	private int <>1__state;
	private object <>2__current;
	public SteamInventoryCrafting <>4__this;
...
private sealed class SteamInventoryCrafting.<>c__DisplayClass33_0 // TypeDefIndex: 13883
{
...
private sealed class SteamInventoryCrafting.<>c__DisplayClass33_1 // TypeDefIndex: 13884
{
...
private struct SteamInventoryCrafting.<ExchangeItems>d__33 : IAsyncStateMachine // TypeDefIndex: 13885
{
	public int <>1__state;
	public AsyncTaskMethodBuilder <>t__builder;
	public SteamInventoryItem[] selected;
...
public class SteamInventoryCrateOpen : MonoBehaviour // TypeDefIndex: 13886
{
...
private sealed class SteamInventoryCrateOpen.<>c__DisplayClass10_0 // TypeDefIndex: 13887
{
...
private sealed class SteamInventoryCrateOpen.<>c // TypeDefIndex: 13888
{
...
private sealed class SteamInventoryCrateOpen.<>c__DisplayClass12_0 // TypeDefIndex: 13889
{
...
private sealed class SteamInventoryCrateOpen.<>c__DisplayClass12_1 // TypeDefIndex: 13890
{
	public InventoryRecipe.Ingredient i;
...
private sealed class SteamInventoryCrateOpen.<>c__DisplayClass12_2 // TypeDefIndex: 13891
{
...
private struct SteamInventoryCrateOpen.<DoCraftAsync>d__12 : IAsyncStateMachine // TypeDefIndex: 13892
{
	public int <>1__state;
	public AsyncTaskMethodBuilder <>t__builder;
...
public class SteamInventoryIcon : MonoBehaviour // TypeDefIndex: 13893
{
...
public class SteamInventoryItem : MonoBehaviour // TypeDefIndex: 13894
{
...
public class SteamInventoryManager : SingletonComponent<SteamInventoryManager> // TypeDefIndex: 13895
{
...
private sealed class SteamInventoryManager.<>c // TypeDefIndex: 13896
{
...
private struct SteamInventoryManager.<Refresh>d__8 : IAsyncStateMachine // TypeDefIndex: 13897
{
	public int <>1__state;
	public AsyncTaskMethodBuilder <>t__builder;
...
private struct SteamInventoryManager.<FixStacks>d__9 : IAsyncStateMachine // TypeDefIndex: 13898
{
	public int <>1__state;
	public AsyncTaskMethodBuilder <>t__builder;
...
public class SteamInventoryNewItem : MonoBehaviour // TypeDefIndex: 13899
{
...
private struct SteamInventoryNewItem.<Open>d__0 : IAsyncStateMachine // TypeDefIndex: 13900
{
	public int <>1__state;
	public AsyncTaskMethodBuilder <>t__builder;
