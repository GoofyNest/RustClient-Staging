...
public static class SteamNetworking // TypeDefIndex: 7371
{
...
public class SteamNetworking.Client : Client, IConnectionManager // TypeDefIndex: 7372
{
...
public class SteamNetworking.Server : Server, ISocketManager // TypeDefIndex: 7373
{
...
private sealed class SteamNetworking.Server.<>c // TypeDefIndex: 7374
{
...
public struct SteamOptions // TypeDefIndex: 9371
{
	[CompilerGeneratedAttribute] 
...
internal struct SteamOptionsInternal : IGettable<SteamOptions>, ISettable<SteamOptions>, IDisposable // TypeDefIndex: 9372
{
...
public class SteamInventory : EntityComponent<BasePlayer> // TypeDefIndex: 10368
{
...
public class SteamInventoryGen : MonoBehaviour // TypeDefIndex: 11052
{
...
public class SteamDLCItem : ScriptableObject // TypeDefIndex: 12505
{
	public int id; 
...
public class SteamInventoryCategory : ScriptableObject // TypeDefIndex: 12506
{
	[HeaderAttribute] 
...
public enum SteamInventoryCategory.Price // TypeDefIndex: 12507
{
	public int value__; 
...
public enum SteamInventoryCategory.DropChance // TypeDefIndex: 12508
{
	public int value__; 
...
public class SteamInventoryItem : ScriptableObject // TypeDefIndex: 12509
{
	public int id; 
	public Sprite icon; 
...
public enum SteamInventoryItem.Category // TypeDefIndex: 12510
{
	public int value__; 
...
public enum SteamInventoryItem.SubCategory // TypeDefIndex: 12511
{
	public int value__; 
...
public class SteamClientWrapper : SingletonComponent<SteamClientWrapper> // TypeDefIndex: 12521
{
...
public enum SteamClientWrapper.RichPresenceState // TypeDefIndex: 12522
{
	public int value__; 
...
public static class SteamNewsSource // TypeDefIndex: 12901
{
...
public struct SteamNewsSource.Story // TypeDefIndex: 12902
{
	public string name; 
	public string url; 
	public int date; 
...
private sealed class SteamNewsSource.<GetStories>d__2 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 12903
{
	private int <>1__state; 
...
public class SteamFriendsList : MonoBehaviour // TypeDefIndex: 12992
{
...
public class SteamFriendsList.onFriendSelectedEvent : UnityEvent<ulong, string> // TypeDefIndex: 12993
{
...
private sealed class SteamFriendsList.<>c__DisplayClass15_0 // TypeDefIndex: 12994
{
...
private sealed class SteamFriendsList.<>c__DisplayClass16_0 // TypeDefIndex: 12995
{
	public IPlayerInfo f; 
...
private sealed class SteamFriendsList.<>c__DisplayClass17_0 // TypeDefIndex: 12996
{
	public string name; 
...
private sealed class SteamFriendsList.<>c__DisplayClass18_0 // TypeDefIndex: 12997
{
...
private sealed class SteamFriendsList.<>c__DisplayClass18_1 // TypeDefIndex: 12998
{
...
private sealed class SteamFriendsList.<>c // TypeDefIndex: 12999
{
...
public class SteamUserButton : MonoBehaviour // TypeDefIndex: 13000
{
...
private struct SteamUserButton.<UpdateFromUser>d__14 : IAsyncStateMachine // TypeDefIndex: 13001
{
	public int <>1__state; 
	public AsyncVoidMethodBuilder <>t__builder; 
...
public class Steam // TypeDefIndex: 13734
{
...
private sealed class Steam.<>c // TypeDefIndex: 13735
{
...
public class SteamInventoryCrafting : MonoBehaviour // TypeDefIndex: 13829
{
...
public class SteamInventoryCrafting.MarketPrice // TypeDefIndex: 13830
{
	[CompilerGeneratedAttribute] 
...
private sealed class SteamInventoryCrafting.<>c__DisplayClass20_0 // TypeDefIndex: 13831
{
...
private sealed class SteamInventoryCrafting.<>c // TypeDefIndex: 13832
{
...
private sealed class SteamInventoryCrafting.<>c__DisplayClass23_0 // TypeDefIndex: 13833
{
...
private struct SteamInventoryCrafting.<GetMarketPrice>d__29 : IAsyncStateMachine // TypeDefIndex: 13834
{
	public int <>1__state; 
...
private struct SteamInventoryCrafting.<GetMarketPriceImpl>d__30 : IAsyncStateMachine // TypeDefIndex: 13835
{
	public int <>1__state; 
	public AsyncTaskMethodBuilder<SteamInventoryCrafting.MarketPrice> <>t__builder; 
	public IPlayerItemDefinition definition; 
...
private sealed class SteamInventoryCrafting.<>c__DisplayClass31_0 // TypeDefIndex: 13836
{
...
private sealed class SteamInventoryCrafting.<LoadMarketPrice>d__31 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 13837
{
	private int <>1__state; 
	private object <>2__current; 
	public SteamInventoryCrafting <>4__this; 
...
private sealed class SteamInventoryCrafting.<>c__DisplayClass33_0 // TypeDefIndex: 13838
{
...
private sealed class SteamInventoryCrafting.<>c__DisplayClass33_1 // TypeDefIndex: 13839
{
...
private struct SteamInventoryCrafting.<ExchangeItems>d__33 : IAsyncStateMachine // TypeDefIndex: 13840
{
	public int <>1__state; 
	public AsyncTaskMethodBuilder <>t__builder; 
	public SteamInventoryItem[] selected; 
...
public class SteamInventoryCrateOpen : MonoBehaviour // TypeDefIndex: 13841
{
...
private sealed class SteamInventoryCrateOpen.<>c__DisplayClass10_0 // TypeDefIndex: 13842
{
...
private sealed class SteamInventoryCrateOpen.<>c // TypeDefIndex: 13843
{
...
private sealed class SteamInventoryCrateOpen.<>c__DisplayClass12_0 // TypeDefIndex: 13844
{
...
private sealed class SteamInventoryCrateOpen.<>c__DisplayClass12_1 // TypeDefIndex: 13845
{
	public InventoryRecipe.Ingredient i; 
...
private sealed class SteamInventoryCrateOpen.<>c__DisplayClass12_2 // TypeDefIndex: 13846
{
...
private struct SteamInventoryCrateOpen.<DoCraftAsync>d__12 : IAsyncStateMachine // TypeDefIndex: 13847
{
	public int <>1__state; 
	public AsyncTaskMethodBuilder <>t__builder; 
...
public class SteamInventoryIcon : MonoBehaviour // TypeDefIndex: 13848
{
...
public class SteamInventoryItem : MonoBehaviour // TypeDefIndex: 13849
{
...
public class SteamInventoryManager : SingletonComponent<SteamInventoryManager> // TypeDefIndex: 13850
{
...
private sealed class SteamInventoryManager.<>c // TypeDefIndex: 13851
{
...
private struct SteamInventoryManager.<Refresh>d__8 : IAsyncStateMachine // TypeDefIndex: 13852
{
	public int <>1__state; 
	public AsyncTaskMethodBuilder <>t__builder; 
...
private struct SteamInventoryManager.<FixStacks>d__9 : IAsyncStateMachine // TypeDefIndex: 13853
{
	public int <>1__state; 
	public AsyncTaskMethodBuilder <>t__builder; 
...
public class SteamInventoryNewItem : MonoBehaviour // TypeDefIndex: 13854
{
...
private struct SteamInventoryNewItem.<Open>d__0 : IAsyncStateMachine // TypeDefIndex: 13855
{
	public int <>1__state; 
	public AsyncTaskMethodBuilder <>t__builder; 
