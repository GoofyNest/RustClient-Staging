internal class Unsafe32LZ4Service : ILZ4Service // TypeDefIndex: 6992
{	// Methods

	// RVA: 0x2261D60 Offset: 0x2260360 VA: 0x182261D60 Slot: 4
	public int Encode(byte[] input, int inputOffset, int inputLength, byte[] output, int outputOffset, int outputLength) { }

	// RVA: 0x2261C30 Offset: 0x2260230 VA: 0x182261C30 Slot: 6
	...
	// RVA: 0x2261CD0 Offset: 0x22602D0 VA: 0x182261CD0 Slot: 5
