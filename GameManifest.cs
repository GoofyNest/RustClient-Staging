public class GameManifest : ScriptableObject // TypeDefIndex: 12433
{
...
public struct GameManifest.PooledString // TypeDefIndex: 12434
{
	[HideInInspector] 
	public string str; 
	public uint hash; 
...
public class GameManifest.PrefabProperties // TypeDefIndex: 12435
{
	[HideInInspector] 
	public string name; 
	public string guid; 
...
public class GameManifest.EffectCategory // TypeDefIndex: 12436
{
	[HideInInspector] 
...
public class GameManifest.GuidPath // TypeDefIndex: 12437
{
	[HideInInspector] 
	public string name; 
	public string guid; 
