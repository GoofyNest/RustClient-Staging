public class GameManifest : ScriptableObject // TypeDefIndex: 12468
{
...
public struct GameManifest.PooledString // TypeDefIndex: 12469
{
	[HideInInspector] 
	public string str; 
	public uint hash; 
...
public class GameManifest.PrefabProperties // TypeDefIndex: 12470
{
	[HideInInspector] 
	public string name; 
	public string guid; 
...
public class GameManifest.EffectCategory // TypeDefIndex: 12471
{
	[HideInInspector] 
...
public class GameManifest.GuidPath // TypeDefIndex: 12472
{
	[HideInInspector] 
	public string name; 
	public string guid; 
