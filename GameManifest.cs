public class GameManifest : ScriptableObject // TypeDefIndex: 12480
{
...
public struct GameManifest.PooledString // TypeDefIndex: 12481
{
	[HideInInspector] 
	public string str; 
	public uint hash; 
...
public class GameManifest.PrefabProperties // TypeDefIndex: 12482
{
	[HideInInspector] 
	public string name; 
	public string guid; 
...
public class GameManifest.EffectCategory // TypeDefIndex: 12483
{
	[HideInInspector] 
...
public class GameManifest.GuidPath // TypeDefIndex: 12484
{
	[HideInInspector] 
	public string name; 
	public string guid; 
