public class ScrollRectEx : UIBehaviour, IInitializePotentialDragHandler, IEventSystemHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutGroup, ILayoutController // TypeDefIndex: 13438
{
...
public enum ScrollRectEx.MovementType // TypeDefIndex: 13439
{
	public int value__; 
...
public enum ScrollRectEx.ScrollbarVisibility // TypeDefIndex: 13440
{
	public int value__; 
...
public class ScrollRectEx.ScrollRectEvent : UnityEvent<Vector2> // TypeDefIndex: 13441
{
