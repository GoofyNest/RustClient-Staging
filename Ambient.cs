...
public class AmbienceDefinition : ScriptableObject // TypeDefIndex: 10705
{
	[HeaderAttribute]
...
public class AmbienceDefinition.ValueRange // TypeDefIndex: 10706
{
	public float min;
	public float max;
...
public class AmbienceDefinitionList : ScriptableObject // TypeDefIndex: 10707
{
...
public class AmbienceEmitter : MonoBehaviour, IClientComponent, IComparable<AmbienceEmitter> // TypeDefIndex: 10708
{
...
public class AmbienceLocalStings : MonoBehaviour // TypeDefIndex: 10709
{
...
public class AmbienceManager : SingletonComponent<AmbienceManager>, IClientComponent // TypeDefIndex: 10710
{
...
public class AmbienceManager.EmitterTypeLimit // TypeDefIndex: 10711
{
...
public class AmbienceManager.AmbienceGroup // TypeDefIndex: 10712
{
...
public class AmbienceSpawnEmitters : MonoBehaviour, IClientComponent // TypeDefIndex: 10713
{
...
public class AmbienceZone : TriggerBase, IClientComponentEx // TypeDefIndex: 10714
{
	public AmbienceDefinitionList baseAmbience;
	public AmbienceDefinitionList stings;
...
public class AmbientLightLOD : FacepunchBehaviour, ILOD, IClientComponent // TypeDefIndex: 13099
{
...
public enum AmbientOcclusionMode // TypeDefIndex: 13569
{
	public int value__;
...
public enum AmbientOcclusionQuality // TypeDefIndex: 13570
{
	public int value__;
...
public sealed class AmbientOcclusionModeParameter : ParameterOverride<AmbientOcclusionMode> // TypeDefIndex: 13571
{
...
public sealed class AmbientOcclusionQualityParameter : ParameterOverride<AmbientOcclusionQuality> // TypeDefIndex: 13572
{
...
public sealed class AmbientOcclusion : PostProcessEffectSettings // TypeDefIndex: 13573
{
	[TooltipAttribute]
...
internal sealed class AmbientOcclusionRenderer : PostProcessEffectRenderer<AmbientOcclusion> // TypeDefIndex: 13575
{
