...
public class AmbienceDefinition : ScriptableObject // TypeDefIndex: 10706
{
	[HeaderAttribute]
...
public class AmbienceDefinition.ValueRange // TypeDefIndex: 10707
{
	public float min;
	public float max;
...
public class AmbienceDefinitionList : ScriptableObject // TypeDefIndex: 10708
{
...
public class AmbienceEmitter : MonoBehaviour, IClientComponent, IComparable<AmbienceEmitter> // TypeDefIndex: 10709
{
...
public class AmbienceLocalStings : MonoBehaviour // TypeDefIndex: 10710
{
...
public class AmbienceManager : SingletonComponent<AmbienceManager>, IClientComponent // TypeDefIndex: 10711
{
...
public class AmbienceManager.EmitterTypeLimit // TypeDefIndex: 10712
{
...
public class AmbienceManager.AmbienceGroup // TypeDefIndex: 10713
{
...
public class AmbienceSpawnEmitters : MonoBehaviour, IClientComponent // TypeDefIndex: 10714
{
...
public class AmbienceZone : TriggerBase, IClientComponentEx // TypeDefIndex: 10715
{
	public AmbienceDefinitionList baseAmbience;
	public AmbienceDefinitionList stings;
...
public class AmbientLightLOD : FacepunchBehaviour, ILOD, IClientComponent // TypeDefIndex: 13101
{
...
public enum AmbientOcclusionMode // TypeDefIndex: 13571
{
	public int value__;
...
public enum AmbientOcclusionQuality // TypeDefIndex: 13572
{
	public int value__;
...
public sealed class AmbientOcclusionModeParameter : ParameterOverride<AmbientOcclusionMode> // TypeDefIndex: 13573
{
...
public sealed class AmbientOcclusionQualityParameter : ParameterOverride<AmbientOcclusionQuality> // TypeDefIndex: 13574
{
...
public sealed class AmbientOcclusion : PostProcessEffectSettings // TypeDefIndex: 13575
{
	[TooltipAttribute]
...
internal sealed class AmbientOcclusionRenderer : PostProcessEffectRenderer<AmbientOcclusion> // TypeDefIndex: 13577
{
