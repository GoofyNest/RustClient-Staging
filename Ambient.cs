...
public class AmbienceDefinition : ScriptableObject // TypeDefIndex: 8971
{
	[HeaderAttribute] 
...
public class AmbienceDefinition.ValueRange // TypeDefIndex: 8972
{
	public float min; 
	public float max; 
...
public class AmbienceDefinitionList : ScriptableObject // TypeDefIndex: 8973
{
...
public class AmbienceEmitter : MonoBehaviour, IClientComponent, IComparable<AmbienceEmitter> // TypeDefIndex: 8974
{
...
public class AmbienceLocalStings : MonoBehaviour // TypeDefIndex: 8975
{
...
public class AmbienceManager : SingletonComponent<AmbienceManager>, IClientComponent // TypeDefIndex: 8976
{
...
public class AmbienceManager.EmitterTypeLimit // TypeDefIndex: 8977
{
...
public class AmbienceManager.AmbienceGroup // TypeDefIndex: 8978
{
...
public class AmbienceSpawnEmitters : MonoBehaviour, IClientComponent // TypeDefIndex: 8979
{
...
public class AmbienceZone : TriggerBase, IClientComponentEx // TypeDefIndex: 8980
{
	public AmbienceDefinitionList baseAmbience; 
	public AmbienceDefinitionList stings; 
...
public class AmbientLightLOD : FacepunchBehaviour, ILOD, IClientComponent // TypeDefIndex: 11320
{
...
public enum AmbientOcclusionMode // TypeDefIndex: 11779
{
	public int value__; 
...
public enum AmbientOcclusionQuality // TypeDefIndex: 11780
{
	public int value__; 
...
public sealed class AmbientOcclusionModeParameter : ParameterOverride<AmbientOcclusionMode> // TypeDefIndex: 11781
{
...
public sealed class AmbientOcclusionQualityParameter : ParameterOverride<AmbientOcclusionQuality> // TypeDefIndex: 11782
{
...
public sealed class AmbientOcclusion : PostProcessEffectSettings // TypeDefIndex: 11783
{
	[TooltipAttribute] 
...
internal sealed class AmbientOcclusionRenderer : PostProcessEffectRenderer<AmbientOcclusion> // TypeDefIndex: 11785
{
