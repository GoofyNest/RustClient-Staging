public class TOD_Animation : MonoBehaviour // TypeDefIndex: 8075
{
	[TooltipAttribute] 
	[TOD_MinAttribute] 
...
public class TOD_MinAttribute : PropertyAttribute // TypeDefIndex: 8076
{
	public float min; 
...
public class TOD_MaxAttribute : PropertyAttribute // TypeDefIndex: 8077
{
	public float max; 
...
public class TOD_RangeAttribute : PropertyAttribute // TypeDefIndex: 8078
{
	public float min; 
	public float max; 
...
public class TOD_Billboard : MonoBehaviour // TypeDefIndex: 8079
{
...
public class TOD_Camera : MonoBehaviour // TypeDefIndex: 8080
{
	public TOD_Sky sky; 
...
public class TOD_Components : MonoBehaviour // TypeDefIndex: 8081
{
...
public enum TOD_MoonPositionType // TypeDefIndex: 8082
{
	public int value__; 
...
public enum TOD_StarsPositionType // TypeDefIndex: 8083
{
	public int value__; 
...
public enum TOD_FogType // TypeDefIndex: 8084
{
	public int value__; 
...
public enum TOD_AmbientType // TypeDefIndex: 8085
{
	public int value__; 
...
public enum TOD_ReflectionType // TypeDefIndex: 8086
{
	public int value__; 
...
public enum TOD_ColorSpaceType // TypeDefIndex: 8087
{
	public int value__; 
...
public enum TOD_ColorRangeType // TypeDefIndex: 8088
{
	public int value__; 
...
public enum TOD_ColorOutputType // TypeDefIndex: 8089
{
	public int value__; 
...
public enum TOD_CloudQualityType // TypeDefIndex: 8090
{
	public int value__; 
...
public enum TOD_MeshQualityType // TypeDefIndex: 8091
{
	public int value__; 
...
public enum TOD_StarQualityType // TypeDefIndex: 8092
{
	public int value__; 
...
public enum TOD_SkyQualityType // TypeDefIndex: 8093
{
	public int value__; 
...
public abstract class TOD_ImageEffect : MonoBehaviour // TypeDefIndex: 8094
{
	public TOD_Sky sky; 
...
public enum TOD_ImageEffect.ResolutionType // TypeDefIndex: 8095
{
	public int value__; 
...
public class TOD_Parameters // TypeDefIndex: 8096
{
...
public class TOD_CycleParameters // TypeDefIndex: 8097
{
	[TooltipAttribute] 
	public float Hour; 
	[TooltipAttribute] 
...
public class TOD_WorldParameters // TypeDefIndex: 8098
{
	[TooltipAttribute] 
	[RangeAttribute] 
...
public class TOD_AtmosphereParameters // TypeDefIndex: 8099
{
	[TooltipAttribute] 
	[TOD_MinAttribute] 
...
public class TOD_DayParameters // TypeDefIndex: 8100
{
	[TooltipAttribute] 
...
public class TOD_NightParameters // TypeDefIndex: 8101
{
	[TooltipAttribute] 
...
public class TOD_SunParameters // TypeDefIndex: 8102
{
	[TooltipAttribute] 
	[TOD_MinAttribute] 
...
public class TOD_MoonParameters // TypeDefIndex: 8103
{
	[TooltipAttribute] 
	[TOD_MinAttribute] 
	public float MeshSize; 
...
public class TOD_StarParameters // TypeDefIndex: 8104
{
	[TooltipAttribute] 
	[TOD_MinAttribute] 
	public float Size; 
...
public class TOD_CloudParameters // TypeDefIndex: 8105
{
	[TooltipAttribute] 
	[TOD_MinAttribute] 
	public float Size; 
...
public class TOD_LightParameters // TypeDefIndex: 8106
{
	[TooltipAttribute] 
	[TOD_MinAttribute] 
...
public class TOD_FogParameters // TypeDefIndex: 8107
{
	[TooltipAttribute] 
...
public class TOD_AmbientParameters // TypeDefIndex: 8108
{
	[TooltipAttribute] 
...
public class TOD_ReflectionParameters // TypeDefIndex: 8109
{
	[TooltipAttribute] 
...
public class TOD_Rays : TOD_ImageEffect // TypeDefIndex: 8110
{
...
public enum TOD_Rays.BlendModeType // TypeDefIndex: 8111
{
	public int value__; 
...
public class TOD_Resources : MonoBehaviour // TypeDefIndex: 8112
{
...
public class TOD_Scattering : TOD_ImageEffect // TypeDefIndex: 8113
{
...
public class TOD_Shadows : TOD_ImageEffect // TypeDefIndex: 8114
{
...
public class TOD_Sky : MonoBehaviour // TypeDefIndex: 8115
{
...
public class TOD_Sky.ReflectionProbeState // TypeDefIndex: 8116
{
...
public class TOD_Time : MonoBehaviour // TypeDefIndex: 8117
{
	[TooltipAttribute] 
	[TOD_MinAttribute] 
...
public static class TOD_Util // TypeDefIndex: 8118
{
...
public abstract class TOD_Audio : MonoBehaviour // TypeDefIndex: 8119
{
...
public class TOD_AudioAtDay : TOD_Audio // TypeDefIndex: 8120
{
...
public class TOD_AudioAtNight : TOD_Audio // TypeDefIndex: 8121
{
	public float fadeTime; 
	private float lerpTime; 
	private float maxVolume; 
...
public class TOD_AudioAtTime : TOD_Audio // TypeDefIndex: 8122
{
...
public abstract class TOD_Light : MonoBehaviour // TypeDefIndex: 8123
{
...
public class TOD_LightAtDay : TOD_Light // TypeDefIndex: 8124
{
	public float fadeTime; 
	private float lerpTime; 
...
public class TOD_LightAtNight : TOD_Light // TypeDefIndex: 8125
{
	public float fadeTime; 
	private float lerpTime; 
	private float maxIntensity; 
...
public class TOD_LightAtTime : TOD_Light // TypeDefIndex: 8126
{
...
public class TOD_LoadSkyFromFile : MonoBehaviour // TypeDefIndex: 8127
{
	public TOD_Sky sky; 
...
public abstract class TOD_Particle : MonoBehaviour // TypeDefIndex: 8128
{
...
public class TOD_ParticleAtDay : TOD_Particle // TypeDefIndex: 8129
{
	public float fadeTime; 
	private float lerpTime; 
...
public class TOD_ParticleAtNight : TOD_Particle // TypeDefIndex: 8130
{
	public float fadeTime; 
	private float lerpTime; 
	private float maxEmission; 
...
public class TOD_ParticleAtTime : TOD_Particle // TypeDefIndex: 8131
{
...
public abstract class TOD_Render : MonoBehaviour // TypeDefIndex: 8132
{
...
public class TOD_RenderAtDay : TOD_Render // TypeDefIndex: 8133
{
...
public class TOD_RenderAtNight : TOD_Render // TypeDefIndex: 8134
{
...
public class TOD_WeatherManager : MonoBehaviour // TypeDefIndex: 8135
{
...
public enum TOD_WeatherManager.RainType // TypeDefIndex: 8136
{
	public int value__; 
...
public enum TOD_WeatherManager.CloudType // TypeDefIndex: 8137
{
	public int value__; 
...
public enum TOD_WeatherManager.AtmosphereType // TypeDefIndex: 8138
{
	public int value__; 
