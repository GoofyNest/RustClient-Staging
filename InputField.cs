public class InputField : Selectable, IUpdateSelectedHandler, IEventSystemHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler, ISubmitHandler, ICanvasElement, ILayoutElement // TypeDefIndex: 4949
{
...
public enum InputField.ContentType // TypeDefIndex: 4950
{
	public int value__; 
...
public enum InputField.InputType // TypeDefIndex: 4951
{
	public int value__; 
...
public enum InputField.CharacterValidation // TypeDefIndex: 4952
{
	public int value__; 
...
public enum InputField.LineType // TypeDefIndex: 4953
{
	public int value__; 
...
public sealed class InputField.OnValidateInput : MulticastDelegate // TypeDefIndex: 4954
{
...
public class InputField.SubmitEvent : UnityEvent<string> // TypeDefIndex: 4955
{
...
public class InputField.OnChangeEvent : UnityEvent<string> // TypeDefIndex: 4956
{
...
private sealed class InputField.<CaretBlink>d__159 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 4958
{
...
private sealed class InputField.<MouseDragOutsideRect>d__179 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 4959
{
	private int <>1__state; 
	private object <>2__current; 
	public InputField <>4__this; 
