public class Scrollbar : Selectable, IBeginDragHandler, IEventSystemHandler, IDragHandler, IInitializePotentialDragHandler, ICanvasElement // TypeDefIndex: 5001
{
	[SerializeField] 
...
public enum Scrollbar.Direction // TypeDefIndex: 5002
{
	public int value__; 
...
public class Scrollbar.ScrollEvent : UnityEvent<float> // TypeDefIndex: 5003
{
...
private enum Scrollbar.Axis // TypeDefIndex: 5004
{
	public int value__; 
...
private sealed class Scrollbar.<ClickRepeat>d__57 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 5005
{
