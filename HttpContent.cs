public abstract class HttpContent : IDisposable // TypeDefIndex: 5747
{
...
private sealed class HttpContent.FixedMemoryStream : MemoryStream // TypeDefIndex: 5748
{
...
private struct HttpContent.<CreateContentReadStreamAsync>d__12 : IAsyncStateMachine // TypeDefIndex: 5749
{
	public int <>1__state; 
...
private struct HttpContent.<LoadIntoBufferAsync>d__17 : IAsyncStateMachine // TypeDefIndex: 5750
{
	public int <>1__state; 
...
private struct HttpContent.<ReadAsStreamAsync>d__18 : IAsyncStateMachine // TypeDefIndex: 5751
{
	public int <>1__state; 
	public AsyncTaskMethodBuilder<Stream> <>t__builder; 
	public HttpContent <>4__this; 
...
private struct HttpContent.<ReadAsStringAsync>d__20 : IAsyncStateMachine // TypeDefIndex: 5752
{
	public int <>1__state; 
