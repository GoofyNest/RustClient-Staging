public class ArcadeMachine : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6367
{
...
public class ArcadeMachine.ScoreEntry : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6368
{
	public bool ShouldPool; 
	private bool _disposed; 
