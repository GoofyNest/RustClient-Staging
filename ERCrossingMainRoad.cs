public class ERCrossingMainRoad : MonoBehaviour // TypeDefIndex: 7265
{
	...
	public List<Vector3> leftOuter1;
	public List<Vector3> rightOuter1;
	public List<Vector2> leftOuterUV1;
	public List<Vector2> rightOuterUV1;
	public List<Vector3> leftOuter2;
	public List<Vector3> rightOuter2;
	public List<Vector2> leftOuterUV2;
	public List<Vector2> rightOuterUV2;
	public List<Vector3> leftOuter3;
	public List<Vector3> rightOuter3;
	public List<Vector2> leftOuterUV3;
	public List<Vector2> rightOuterUV3;
