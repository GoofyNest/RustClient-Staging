public class MusicTheme : ScriptableObject // TypeDefIndex: 9009
{
	[HeaderAttribute] 
	public float tempo; 
...
public class MusicTheme.Layer // TypeDefIndex: 9010
{
	public string name; 
...
public class MusicTheme.PositionedClip // TypeDefIndex: 9011
{
...
public class MusicTheme.ValueRange // TypeDefIndex: 9012
{
	public float min; 
	public float max; 
