public class LightString : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6375
{
...
public class LightString.StringPoint : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6376
{
	public bool ShouldPool; 
	private bool _disposed; 
