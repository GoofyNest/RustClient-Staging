public static class WebUtil // TypeDefIndex: 6233
{
...
private class WebUtil.AcceptAllCertificates : CertificateHandler // TypeDefIndex: 6234
{
...
private sealed class WebUtil.<DownloadStringCoroutine>d__2 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 6235
{
...
private struct WebUtil.<DownloadFileTemp>d__3 : IAsyncStateMachine // TypeDefIndex: 6236
{
	public int <>1__state; 
...
private struct WebUtil.<PostAsync>d__6 : IAsyncStateMachine // TypeDefIndex: 6237
{
	public int <>1__state; 
	public AsyncTaskMethodBuilder<string> <>t__builder; 
	public string url; 
...
private struct WebUtil.<PostDataAsync>d__8 : IAsyncStateMachine // TypeDefIndex: 6238
{
	public int <>1__state; 
	public AsyncTaskMethodBuilder<string> <>t__builder; 
...
private sealed class WebUtil.<PostValuesCoroutine>d__9 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 6239
{
	private int <>1__state; 
	private object <>2__current; 
	public WWW www; 
