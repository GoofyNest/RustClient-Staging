public class ScrollRect : UIBehaviour, IInitializePotentialDragHandler, IEventSystemHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup, ILayoutController // TypeDefIndex: 4997
{
	[SerializeField] 
...
public enum ScrollRect.MovementType // TypeDefIndex: 4998
{
	public int value__; 
...
public enum ScrollRect.ScrollbarVisibility // TypeDefIndex: 4999
{
	public int value__; 
...
public class ScrollRect.ScrollRectEvent : UnityEvent<Vector2> // TypeDefIndex: 5000
{
