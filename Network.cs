...
internal enum ConnectionChangeType // TypeDefIndex: 4145
{
	public uint value__; 
...
public enum ConnectionState // TypeDefIndex: 4175
{
	public int value__; 
...
public enum ConnectionState // TypeDefIndex: 5172
{
	public int value__; 
...
internal enum NetConfigScope // TypeDefIndex: 5173
{
	public int value__; 
...
internal enum NetConfigType // TypeDefIndex: 5174
{
	public int value__; 
...
internal enum NetConfig // TypeDefIndex: 5175
{
	public int value__; 
...
internal enum NetConfigResult // TypeDefIndex: 5176
{
	public int value__; 
...
public enum NetDebugOutput // TypeDefIndex: 5177
{
	public int value__; 
...
public class ConnectionManager // TypeDefIndex: 5181
{
...
internal sealed class NetDebugFunc : MulticastDelegate // TypeDefIndex: 5182
{
...
internal struct NetKeyValue // TypeDefIndex: 5510
{
...
public struct NetIdentity // TypeDefIndex: 5511
{
...
internal enum NetIdentity.IdentityType // TypeDefIndex: 5512
{
	public int value__; 
...
public struct NetAddress // TypeDefIndex: 5513
{
...
internal struct NetAddress.IPV4 // TypeDefIndex: 5514
{
...
internal struct NetMsg // TypeDefIndex: 5515
{
...
public struct Connection : IEquatable<Connection> // TypeDefIndex: 5546
{
	[CompilerGeneratedAttribute] 
...
public struct ConnectionInfo // TypeDefIndex: 5547
{
	internal NetIdentity identity; 
	internal long userData; 
...
public struct ConnectionLaneStatus // TypeDefIndex: 5548
{
...
public struct ConnectionStatus // TypeDefIndex: 5549
{
	internal ConnectionState state; 
	internal int ping; 
...
public class Connection // TypeDefIndex: 6849
{
...
public enum Connection.State // TypeDefIndex: 6850
{
	public int value__; 
...
public struct Connection.Validation // TypeDefIndex: 6851
{
	public uint entityUpdates; 

}

public class Connection.ClientInfo // TypeDefIndex: 6852
{
...
public class NetRead : Stream // TypeDefIndex: 6862
{
...
public class NetWrite : MemoryStream // TypeDefIndex: 6863
{
...
public class Networkable : Pool.IPooled // TypeDefIndex: 6867
{
	public uint ID; 
	[CompilerGeneratedAttribute] 
...
public class QueuedStream : Stream // TypeDefIndex: 6947
{
...
private class QueuedStream.WriteData // TypeDefIndex: 6948
{
...
private class QueuedStream.QueuedWriteResult : IAsyncResult // TypeDefIndex: 6949
{
...
private sealed class QueuedStream.<>c__DisplayClass27_0 // TypeDefIndex: 6950
{
...
public class NetGraph : SingletonComponent<NetGraph> // TypeDefIndex: 7107
{
...
private sealed class NetGraph.<>c // TypeDefIndex: 7108
{
...
public class NetGraphItem : MonoBehaviour // TypeDefIndex: 7109
{
	public CanvasGroup group; 
...
public class NetGraphRow : MonoBehaviour // TypeDefIndex: 7110
{
	public CanvasGroup group; 
	public Text countTotal; 
...
private sealed class NetGraphRow.<>c // TypeDefIndex: 7111
{
...
public class Net // TypeDefIndex: 8233
{
	[CompilerGeneratedAttribute] 
...
public enum ConnectionClosedReason // TypeDefIndex: 8939
{
	public int value__; 
...
public enum ConnectionEstablishedType // TypeDefIndex: 8940
{
	public int value__; 
...
public enum NetworkConnectionType // TypeDefIndex: 8952
{
	public int value__; 
...
public enum NetworkStatus // TypeDefIndex: 9861
{
	public int value__; 
...
public class NetworkInfoGeneralText : MonoBehaviour // TypeDefIndex: 10988
{
...
public abstract class NetworkCryptography : INetworkCryptocraphy // TypeDefIndex: 11942
{
	private byte[] buffer; 
...
public class NetworkCryptographyClient : NetworkCryptography // TypeDefIndex: 11943
{
...
public class NetworkVisibilityGrid : MonoBehaviour // TypeDefIndex: 11944
{
	public int startID; 
	public int gridSize; 
...
public class ConnectionAuth : MonoBehaviour // TypeDefIndex: 12418
{
...
public class ConnectionQueue // TypeDefIndex: 12419
{
...
public class ConnectionScreen : SingletonComponent<ConnectionScreen> // TypeDefIndex: 12820
{
...
private struct ConnectionScreen.<LoadServerInfo>d__13 : IAsyncStateMachine // TypeDefIndex: 12821
{
	public int <>1__state; 
...
private struct ConnectionScreen.<LoadServerRules>d__14 : IAsyncStateMachine // TypeDefIndex: 12822
{
	public int <>1__state; 
	public AsyncVoidMethodBuilder <>t__builder; 
...
public class NetworkSleep : MonoBehaviour // TypeDefIndex: 13047
{
...
public static class NetworkWriteEx // TypeDefIndex: 13073
{
...
public class NetworkedProperty<T> // TypeDefIndex: 13155
{
	private T val; 
...
public sealed class ProxyArray : Variant, IEnumerable<Variant>, IEnumerable // TypeDefIndex: 13308
{
...
public sealed class ProxyBoolean : Variant // TypeDefIndex: 13309
{
...
public sealed class ProxyNumber : Variant // TypeDefIndex: 13310
{
...
public sealed class ProxyObject : Variant, IEnumerable<KeyValuePair<string, Variant>>, IEnumerable // TypeDefIndex: 13311
{
...
public sealed class ProxyString : Variant // TypeDefIndex: 13312
{
...
public class ConnectionLimiter // TypeDefIndex: 13370
{
...
private sealed class ConnectionLimiter.<>c // TypeDefIndex: 13371
{
...
public static class NetworkPacketEx // TypeDefIndex: 13428
{
...
public class Net : ConsoleSystem // TypeDefIndex: 13672
{
	[ServerVar] 
...
public class Netgraph : ConsoleSystem // TypeDefIndex: 13673
{
	[ClientVar] 
