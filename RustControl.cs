public class RustControl : UIBehaviour, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler // TypeDefIndex: 7018
{
...
public enum RustControl.State // TypeDefIndex: 7019
{
	public int value__; 
