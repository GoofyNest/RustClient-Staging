public class RustControl : UIBehaviour, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler // TypeDefIndex: 7050
{
...
public enum RustControl.State // TypeDefIndex: 7051
{
	public int value__; 
