public class RustControl : UIBehaviour, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler // TypeDefIndex: 7053
{
...
public enum RustControl.State // TypeDefIndex: 7054
{
	public int value__; 
