internal sealed class NotesBuilder // TypeDefIndex: 7445
{
...
private class NotesBuilder.NoteDescriptor // TypeDefIndex: 7446
{
...
private abstract class NotesBuilder.NoteOnsHolderBase<TDescriptor> // TypeDefIndex: 7447
{
...
private sealed class NotesBuilder.NoteOnsHolder : NotesBuilder.NoteOnsHolderBase<NotesBuilder.NoteDescriptor> // TypeDefIndex: 7448
{
...
private sealed class NotesBuilder.<GetNotesLazy>d__7 : IEnumerable<Note>, IEnumerable, IEnumerator<Note>, IDisposable, IEnumerator // TypeDefIndex: 7449
{
...
private sealed class NotesBuilder.<GetNotesLazy>d__8 : IEnumerable<Note>, IEnumerable, IEnumerator<Note>, IDisposable, IEnumerator // TypeDefIndex: 7450
{
	private int <>1__state; 
	private Note <>2__current; 
	private int <>l__initialThreadId; 
