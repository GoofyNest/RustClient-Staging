...
public class BasePlayer : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6447
{
	public bool ShouldPool; 
	private bool _disposed; 
	public string name; 
...
public class PlayerTeam : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6448
{
	public bool ShouldPool; 
	private bool _disposed; 
	public ulong teamID; 
...
public class PlayerTeam.TeamMember : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6449
{
	public bool ShouldPool; 
	private bool _disposed; 
...
public class PlayerMetabolism : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6450
{
	public bool ShouldPool; 
	private bool _disposed; 
	public float health; 
...
public class PlayerModifiers : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6451
{
	public bool ShouldPool; 
	private bool _disposed; 
...
public class PlayerInventory : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6458
{
	public bool ShouldPool; 
	private bool _disposed; 
...
public class PlayerLifeStory : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6460
{
	public bool ShouldPool; 
	private bool _disposed; 
...
public class PlayerLifeStory.DeathInfo : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6461
{
	public bool ShouldPool; 
	private bool _disposed; 
...
public class PlayerLifeStory.WeaponStats : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6462
{
	public bool ShouldPool; 
	private bool _disposed; 
...
public class PlayerLifeStory.GenericStat : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6463
{
	public bool ShouldPool; 
	private bool _disposed; 
	public string key; 
...
public class PlayerState : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6466
{
	public bool ShouldPool; 
	private bool _disposed; 
...
public class PlayerNameID : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6467
{
	public bool ShouldPool; 
	private bool _disposed; 
...
public class PlayerUpdateLoot : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6482
{
	public bool ShouldPool; 
	private bool _disposed; 
	public uint itemID; 
...
public class PlayerAttack : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6488
{
	public bool ShouldPool; 
	private bool _disposed; 
...
public class PlayerProjectileAttack : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6489
{
	public bool ShouldPool; 
	private bool _disposed; 
...
public class PlayerProjectileRicochet : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6490
{
	public bool ShouldPool; 
	private bool _disposed; 
	public int projectileID; 
...
public class PlayerProjectileUpdate : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6491
{
	public bool ShouldPool; 
	private bool _disposed; 
	public int projectileID; 
...
public class PlayerDetectedAIEventData : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6548
{
	public bool ShouldPool; 
	private bool _disposed; 
	public float range; 
...
public struct PlayerSanction // TypeDefIndex: 8614
{
	[CompilerGeneratedAttribute] 
...
internal struct PlayerSanctionInternal : IGettable<PlayerSanction>, ISettable<PlayerSanction>, IDisposable // TypeDefIndex: 8615
{
...
public enum PlayerReportsCategory // TypeDefIndex: 8623
{
	public int value__; 
...
public sealed class PlayerDataStorageFileTransferRequest : Handle // TypeDefIndex: 8899
{
...
public sealed class PlayerDataStorageInterface : Handle // TypeDefIndex: 8900
{
...
public struct PlayerAchievement // TypeDefIndex: 9928
{
	[CompilerGeneratedAttribute] 
...
internal struct PlayerAchievementInternal : IGettable<PlayerAchievement>, ISettable<PlayerAchievement>, IDisposable // TypeDefIndex: 9929
{
	private int m_ApiVersion; 
...
public struct PlayerStatInfo // TypeDefIndex: 9930
{
	[CompilerGeneratedAttribute] 
...
internal struct PlayerStatInfoInternal : IGettable<PlayerStatInfo>, ISettable<PlayerStatInfo>, IDisposable // TypeDefIndex: 9931
{
	private int m_ApiVersion; 
...
public class PlayerIdleAnimationRandomiser : StateMachineBehaviour // TypeDefIndex: 9973
{
	public int MaxValue; 
...
public class BasePlayer : BaseCombatEntity, LootPanel.IHasLootPanel, IIdealSlotEntity // TypeDefIndex: 10040
{
...
public enum BasePlayer.CameraMode // TypeDefIndex: 10041
{
	public int value__; 
...
public enum BasePlayer.PlayerFlags // TypeDefIndex: 10042
{
	public int value__; 
...
public enum BasePlayer.MapNoteType // TypeDefIndex: 10043
{
	public int value__; 
...
public enum BasePlayer.TimeCategory // TypeDefIndex: 10044
{
	public int value__; 
...
public struct BasePlayer.CapsuleColliderInfo // TypeDefIndex: 10045
{
	public float height; 
	public float radius; 
...
private sealed class BasePlayer.<>c // TypeDefIndex: 10046
{
...
private sealed class BasePlayer.<FinishedLoadingRoutine>d__161 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 10047
{
...
private sealed class BasePlayer.<>c__DisplayClass210_0 // TypeDefIndex: 10048
{
...
private sealed class BasePlayer.<>c__DisplayClass304_0 // TypeDefIndex: 10049
{
	public uint index; 
