public class AIDesign : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6547
{
...
public class AIStateContainer : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6548
{
	public bool ShouldPool; 
	private bool _disposed; 
	public int id; 
...
public class AIEventData : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6549
{
	public bool ShouldPool; 
	private bool _disposed; 
...
public class NPCTalking : NPCShopKeeper, IConversationProvider // TypeDefIndex: 10135
{
...
public class NPCTalking.NPCConversationResultAction // TypeDefIndex: 10136
{
...
public class NPCVendingOrder : ScriptableObject // TypeDefIndex: 10436
{
...
public class NPCVendingOrder.Entry // TypeDefIndex: 10437
{
...
public class NPCVendingOrderManifest : ScriptableObject // TypeDefIndex: 10438
{
...
public class NPCVendingMachine : VendingMachine // TypeDefIndex: 10439
{
...
public class NPCDwelling : BaseEntity // TypeDefIndex: 10535
{
...
public class NPCMissionProvider : NPCTalking, IMissionProvider // TypeDefIndex: 10568
{
...
public class NPCShopKeeper : NPCPlayer // TypeDefIndex: 10569
{
...
public class NPCPlayerCorpse : PlayerCorpse // TypeDefIndex: 10586
{
...
public class AICoverPoint : AIPoint // TypeDefIndex: 10622
{
...
public class AICoverPointTool : MonoBehaviour // TypeDefIndex: 10623
{
...
private struct AICoverPointTool.TestResult // TypeDefIndex: 10624
{
...
public class AIInformationCell // TypeDefIndex: 10625
{
...
public class AIInformationCellContents<T> // TypeDefIndex: 10626
{
...
public class AIInformationGrid : MonoBehaviour // TypeDefIndex: 10627
{
	public int CellSize; 
	public Bounds BoundingBox; 
...
public class AIInformationGridTester : MonoBehaviour // TypeDefIndex: 10628
{
...
public class AIInformationZone : BaseMonoBehaviour, IServerComponent // TypeDefIndex: 10629
{
...
public class AIMovePoint : AIPoint // TypeDefIndex: 10630
{
...
public class AIMovePoint.DistTo // TypeDefIndex: 10631
{
...
public class AIMovePointPath : MonoBehaviour // TypeDefIndex: 10632
{
...
public enum AIMovePointPath.Mode // TypeDefIndex: 10633
{
	public int value__; 
...
public enum AIMovePointPath.PathDirection // TypeDefIndex: 10634
{
	public int value__; 
...
public class AIPoint : BaseMonoBehaviour // TypeDefIndex: 10635
{
...
public class AITraversalArea : TriggerBase // TypeDefIndex: 10636
{
...
public class AITraversalWaitPoint : MonoBehaviour // TypeDefIndex: 10637
{
	public float nextFreeTime; 
...
public class AnimalBrain : BaseAIBrain // TypeDefIndex: 10638
{
...
public class AnimalRagdoll : Ragdoll // TypeDefIndex: 10645
{
...
public class AIThinkManager : BaseMonoBehaviour, IServerComponent // TypeDefIndex: 10648
{
...
public class ScientistBrain : BaseAIBrain // TypeDefIndex: 10652
{
...
public class ScientistNPC : HumanNPC, IAIMounted // TypeDefIndex: 10653
{
...
public enum ScientistNPC.RadioChatterType // TypeDefIndex: 10654
{
	public int value__; 
...
public class NPCPlayer : BasePlayer // TypeDefIndex: 10657
{
...
public class NPCNavigator : BaseNavigator // TypeDefIndex: 10672
{
...
public class NPCPlayerNavigator : BaseNavigator // TypeDefIndex: 10673
{
...
public class NPCPlayerNavigatorTester : BaseMonoBehaviour // TypeDefIndex: 10674
{
...
public enum AIState // TypeDefIndex: 10683
{
	public int value__; 
...
public enum AIThinkMode // TypeDefIndex: 10684
{
	public int value__; 
...
public class AimConeUtil // TypeDefIndex: 10687
{
...
public class AnimalSkin : MonoBehaviour, IClientComponent // TypeDefIndex: 10830
{
...
public class AnimalMultiSkin // TypeDefIndex: 10831
{
...
public class AnimalAnimation : MonoBehaviour, IClientComponent // TypeDefIndex: 10832
{
	public BaseEntity Entity; 
...
public class AnimalFootIK : MonoBehaviour // TypeDefIndex: 10834
{
	public Transform[] Feet; 
	public Animator animator; 
...
public class NPCFootstepEffects : BaseFootstepEffect // TypeDefIndex: 11079
{
...
public class AIBrainSenses // TypeDefIndex: 11101
{
...
public class AIDesignSO : BaseScriptableObject // TypeDefIndex: 11102
{
...
public class AIDesign // TypeDefIndex: 11103
{
	[CompilerGeneratedAttribute] 
...
public static class AIDesigns // TypeDefIndex: 11104
{
...
public enum AIEventType // TypeDefIndex: 11105
{
	public int value__; 
...
public class AIEvents // TypeDefIndex: 11106
{
...
public class AIMemory // TypeDefIndex: 11107
{
...
public class AIMemoryBank<T> // TypeDefIndex: 11112
{
...
public class AIStateContainer // TypeDefIndex: 11146
{
	[CompilerGeneratedAttribute] 
...
public enum AIDesignScope // TypeDefIndex: 11149
{
	public int value__; 
...
public class NPCAutoTurret : AutoTurret // TypeDefIndex: 11302
{
...
public class AIHelicopterAnimation : MonoBehaviour // TypeDefIndex: 11323
{
...
public class NPCSpawner : SpawnGroup // TypeDefIndex: 11732
{
...
public class AI : ConsoleSystem // TypeDefIndex: 13642
{
	[ReplicatedVar] 
...
public class AiManagedAgent : FacepunchBehaviour, IServerComponent // TypeDefIndex: 13903
{
	[TooltipAttribute] 
...
public class AiManager : SingletonComponent<AiManager>, IServerComponent // TypeDefIndex: 13904
{
	[HeaderAttribute] 
	[SerializeField] 
...
public class ScientistSpawner : SpawnGroup // TypeDefIndex: 13906
{
	[HeaderAttribute] 
	public bool Mobile; 
...
public class AiLocationManager : FacepunchBehaviour, IServerComponent // TypeDefIndex: 13907
{
...
public class AiLocationSpawner : SpawnGroup // TypeDefIndex: 13908
{
...
public enum AiLocationSpawner.SquadSpawnerLocation // TypeDefIndex: 13909
{
	public int value__; 
...
public class ScientistJunkpileSpawner : MonoBehaviour, IServerComponent // TypeDefIndex: 13913
{
...
public enum ScientistJunkpileSpawner.JunkpileType // TypeDefIndex: 13914
{
	public int value__; 
