...
public class EffectMount : EntityComponent<BaseEntity>, IClientComponent // TypeDefIndex: 8888
{
...
public class EffectParent : EntityComponent<BaseEntity>, IClientComponent // TypeDefIndex: 8889
{
...
public class Effect : EffectData // TypeDefIndex: 9333
{
	public Vector3 Up; 
...
public enum Effect.Type // TypeDefIndex: 9334
{
	public uint value__; 
...
public static class Effect.client // TypeDefIndex: 9335
{
...
public static class Effect.server // TypeDefIndex: 9336
{
...
public class EffectAudioPerspectiveSwitcher : MonoBehaviour, IEffect, IPrefabPreProcess // TypeDefIndex: 9337
{
	[HideInInspector] 
...
public static class EffectLibrary // TypeDefIndex: 9340
{
...
public class EffectMuzzleFlash : MonoBehaviour, IEffect // TypeDefIndex: 9341
{
...
public static class EffectNetwork // TypeDefIndex: 9342
{
...
public class EffectParentToWeaponBone : BaseMonoBehaviour, IEffect // TypeDefIndex: 9343
{
...
public class EffectScaleWithCameraDistance : MonoBehaviour, IEffect // TypeDefIndex: 9344
{
...
public class EffectBlood : EffectRecycle // TypeDefIndex: 9858
{
...
public class EffectDictionary // TypeDefIndex: 9859
{
...
public class EffectRecycle : BaseMonoBehaviour, IClientComponent, IRagdollInhert, IEffectRecycle, IOnParentDestroying // TypeDefIndex: 9860
{
...
public enum EffectRecycle.PlayMode // TypeDefIndex: 9861
{
	public int value__; 
...
public enum EffectRecycle.ParentDestroyBehaviour // TypeDefIndex: 9862
{
	public int value__; 
...
public class EffectRecycleDetach : BaseMonoBehaviour, IClientComponent, IEffectRecycle, IOnParentDestroying // TypeDefIndex: 9863
{
	public float recycleTime; 
	private Action recycleAction; 
...
public class EffectRecycleLite : BasePrefab, IClientComponent, IEffectRecycle, IOnParentDestroying // TypeDefIndex: 9864
{
...
public class Effects : ConsoleSystem // TypeDefIndex: 11933
{
...
public enum Effects.AntiAliasingType // TypeDefIndex: 11934
{
	public int value__; 
