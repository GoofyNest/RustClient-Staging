...
public class EffectsBenchmarkScene : BenchmarkScene // TypeDefIndex: 9969
{
...
private sealed class EffectsBenchmarkScene.<DoEffectBenchmark>d__6 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 9970
{
...
public class EffectMount : EntityComponent<BaseEntity>, IClientComponent // TypeDefIndex: 10621
{
...
public class EffectParent : EntityComponent<BaseEntity>, IClientComponent // TypeDefIndex: 10622
{
...
public class Effect : EffectData // TypeDefIndex: 11080
{
	public Vector3 Up;
...
public enum Effect.Type // TypeDefIndex: 11081
{
	public uint value__;
...
public static class Effect.client // TypeDefIndex: 11082
{
...
public static class Effect.server // TypeDefIndex: 11083
{
...
public class EffectAudioPerspectiveSwitcher : MonoBehaviour, IEffect, IPrefabPreProcess // TypeDefIndex: 11084
{
	[HideInInspector]
...
public static class EffectLibrary // TypeDefIndex: 11087
{
...
public class EffectMuzzleFlash : MonoBehaviour, IEffect // TypeDefIndex: 11088
{
...
public static class EffectNetwork // TypeDefIndex: 11089
{
...
public class EffectParentToWeaponBone : BaseMonoBehaviour, IEffect // TypeDefIndex: 11090
{
...
public class EffectScaleWithCameraDistance : MonoBehaviour, IEffect // TypeDefIndex: 11091
{
...
public class EffectBlood : EffectRecycle // TypeDefIndex: 11608
{
...
public class EffectDictionary // TypeDefIndex: 11609
{
...
public class EffectRecycle : BaseMonoBehaviour, IClientComponent, IRagdollInhert, IEffectRecycle, IOnParentDestroying // TypeDefIndex: 11610
{
...
public enum EffectRecycle.PlayMode // TypeDefIndex: 11611
{
	public int value__;
...
public enum EffectRecycle.ParentDestroyBehaviour // TypeDefIndex: 11612
{
	public int value__;
...
public class EffectRecycleDetach : BaseMonoBehaviour, IClientComponent, IEffectRecycle, IOnParentDestroying // TypeDefIndex: 11613
{
	public float recycleTime;
	private Action recycleAction;
...
public class EffectRecycleLite : BasePrefab, IClientComponent, IEffectRecycle, IOnParentDestroying // TypeDefIndex: 11614
{
...
public class Effects : ConsoleSystem // TypeDefIndex: 13725
{
...
public enum Effects.AntiAliasingType // TypeDefIndex: 13726
{
	public int value__;
