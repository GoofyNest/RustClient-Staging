public class ShoutcastStreamer : MonoBehaviour, IClientComponent // TypeDefIndex: 9022
{
	public string Host; 
...
private struct ShoutcastStreamer.<ReadData>d__46 : IAsyncStateMachine // TypeDefIndex: 9023
{
	public int <>1__state; 
