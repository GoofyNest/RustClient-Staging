public class TMP_Asset : ScriptableObject // TypeDefIndex: 6679
{
	public int hashCode; 
...
public class TMP_Character : TMP_TextElement // TypeDefIndex: 6680
{
...
public struct TMP_Vertex // TypeDefIndex: 6681
{
...
public struct TMP_CharacterInfo // TypeDefIndex: 6682
{
...
public class TMP_ColorGradient : ScriptableObject // TypeDefIndex: 6684
{
...
public static class TMP_DefaultControls // TypeDefIndex: 6693
{
...
public struct TMP_DefaultControls.Resources // TypeDefIndex: 6694
{
...
public class TMP_FontAsset : TMP_Asset // TypeDefIndex: 6696
{
	[SerializeField] 
...
private sealed class TMP_FontAsset.<>c // TypeDefIndex: 6697
{
...
public class TMP_Glyph : TMP_TextElement_Legacy // TypeDefIndex: 6699
{
...
public struct TMP_FontWeightPair // TypeDefIndex: 6701
{
...
public static class TMP_FontUtilities // TypeDefIndex: 6710
{
...
public class TMP_FontAssetUtilities // TypeDefIndex: 6711
{
...
public class TMP_FontFeatureTable // TypeDefIndex: 6712
{
	[SerializeField] 
...
private sealed class TMP_FontFeatureTable.<>c // TypeDefIndex: 6713
{
...
public struct TMP_GlyphValueRecord // TypeDefIndex: 6715
{
	[SerializeField] 
...
public struct TMP_GlyphAdjustmentRecord // TypeDefIndex: 6716
{
	[SerializeField] 
...
public class TMP_GlyphPairAdjustmentRecord // TypeDefIndex: 6717
{
	[SerializeField] 
...
public class TMP_InputField : Selectable, IUpdateSelectedHandler, IEventSystemHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler, ISubmitHandler, ICanvasElement, ILayoutElement, IScrollHandler // TypeDefIndex: 6719
{
...
public enum TMP_InputField.ContentType // TypeDefIndex: 6720
{
	public int value__; 
...
public enum TMP_InputField.InputType // TypeDefIndex: 6721
{
	public int value__; 
...
public enum TMP_InputField.CharacterValidation // TypeDefIndex: 6722
{
	public int value__; 
...
public enum TMP_InputField.LineType // TypeDefIndex: 6723
{
	public int value__; 
...
public sealed class TMP_InputField.OnValidateInput : MulticastDelegate // TypeDefIndex: 6724
{
...
public class TMP_InputField.SubmitEvent : UnityEvent<string> // TypeDefIndex: 6725
{
...
public class TMP_InputField.OnChangeEvent : UnityEvent<string> // TypeDefIndex: 6726
{
...
public class TMP_InputField.SelectionEvent : UnityEvent<string> // TypeDefIndex: 6727
{
...
public class TMP_InputField.TextSelectionEvent : UnityEvent<string, int, int> // TypeDefIndex: 6728
{
...
public class TMP_InputField.TouchScreenKeyboardEvent : UnityEvent<TouchScreenKeyboard.Status> // TypeDefIndex: 6729
{
...
private sealed class TMP_InputField.<CaretBlink>d__267 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 6731
{
...
private sealed class TMP_InputField.<MouseDragOutsideRect>d__285 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 6732
{
	private int <>1__state; 
	private object <>2__current; 
	public TMP_InputField <>4__this; 
...
public abstract class TMP_InputValidator : ScriptableObject // TypeDefIndex: 6734
{
...
public struct TMP_LineInfo // TypeDefIndex: 6735
{
...
internal static class TMP_ListPool<T> // TypeDefIndex: 6736
{
...
private sealed class TMP_ListPool.<>c<T> // TypeDefIndex: 6737
{
...
public static class TMP_MaterialManager // TypeDefIndex: 6738
{
...
private class TMP_MaterialManager.FallbackMaterial // TypeDefIndex: 6739
{
	public int baseID; 
...
private class TMP_MaterialManager.MaskingMaterial // TypeDefIndex: 6740
{
	public Material baseMaterial; 
...
private sealed class TMP_MaterialManager.<>c__DisplayClass10_0 // TypeDefIndex: 6741
{
	public Material stencilMaterial; 
...
private sealed class TMP_MaterialManager.<>c__DisplayClass12_0 // TypeDefIndex: 6742
{
	public Material stencilMaterial; 
...
private sealed class TMP_MaterialManager.<>c__DisplayClass13_0 // TypeDefIndex: 6743
{
	public Material stencilMaterial; 
...
private sealed class TMP_MaterialManager.<>c__DisplayClass14_0 // TypeDefIndex: 6744
{
	public Material baseMaterial; 
...
public struct TMP_MeshInfo // TypeDefIndex: 6746
{
...
internal class TMP_ObjectPool<T> // TypeDefIndex: 6747
{
...
public struct TMP_FontStyleStack // TypeDefIndex: 6748
{
	public byte bold; 
	public byte italic; 
...
public struct TMP_RichTextTagStack<T> // TypeDefIndex: 6749
{
...
public class TMP_ScrollbarEventHandler : MonoBehaviour, IPointerClickHandler, IEventSystemHandler, ISelectHandler, IDeselectHandler // TypeDefIndex: 6754
{
...
public class TMP_SelectionCaret : MaskableGraphic // TypeDefIndex: 6755
{
...
public class TMP_Settings : ScriptableObject // TypeDefIndex: 6756
{
...
public class TMP_Settings.LineBreakingTable // TypeDefIndex: 6757
{
...
public class TMP_SubMesh : MonoBehaviour // TypeDefIndex: 6759
{
	[SerializeField] 
...
public class TMP_SubMeshUI : MaskableGraphic, IClippable, IMaskable, IMaterialModifier // TypeDefIndex: 6760
{
	[SerializeField] 
	private TMP_FontAsset m_fontAsset; 
	[SerializeField] 
...
public enum TMP_TextElementType // TypeDefIndex: 6766
{
	public int value__; 
...
public abstract class TMP_Text : MaskableGraphic // TypeDefIndex: 6773
{
	[SerializeField] 
	[TextAreaAttribute] 
	protected string m_text; 
...
public class TMP_TextElement // TypeDefIndex: 6776
{
	[SerializeField] 
...
public class TMP_TextElement_Legacy // TypeDefIndex: 6777
{
	public int id; 
	public float x; 
	public float y; 
...
public class TMP_TextInfo // TypeDefIndex: 6778
{
...
public class TMP_TextParsingUtilities // TypeDefIndex: 6779
{
...
public static class TMP_TextUtilities // TypeDefIndex: 6782
{
...
private struct TMP_TextUtilities.LineSegment // TypeDefIndex: 6783
{
...
public class TMP_UpdateManager // TypeDefIndex: 6784
{
...
public class TMP_UpdateRegistry // TypeDefIndex: 6785
{
...
public static class TMP_Math // TypeDefIndex: 6790
{
...
public enum TMP_VertexDataUpdateFlags // TypeDefIndex: 6791
{
	public int value__; 
...
public struct TMP_PageInfo // TypeDefIndex: 6793
{
	public int firstCharacterIndex; 
	public int lastCharacterIndex; 
	public float ascender; 
...
public struct TMP_LinkInfo // TypeDefIndex: 6794
{
	public TMP_Text textComponent; 
	public int hashCode; 
...
public struct TMP_WordInfo // TypeDefIndex: 6795
{
	public TMP_Text textComponent; 
	public int firstCharacterIndex; 
	public int lastCharacterIndex; 
...
public struct TMP_SpriteInfo // TypeDefIndex: 6796
{
