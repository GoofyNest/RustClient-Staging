public class TMP_Asset : ScriptableObject // TypeDefIndex: 6678
{
	public int hashCode; 
...
public class TMP_Character : TMP_TextElement // TypeDefIndex: 6679
{
...
public struct TMP_Vertex // TypeDefIndex: 6680
{
...
public struct TMP_CharacterInfo // TypeDefIndex: 6681
{
...
public class TMP_ColorGradient : ScriptableObject // TypeDefIndex: 6683
{
...
public static class TMP_DefaultControls // TypeDefIndex: 6692
{
...
public struct TMP_DefaultControls.Resources // TypeDefIndex: 6693
{
...
public class TMP_FontAsset : TMP_Asset // TypeDefIndex: 6695
{
	[SerializeField] 
...
private sealed class TMP_FontAsset.<>c // TypeDefIndex: 6696
{
...
public class TMP_Glyph : TMP_TextElement_Legacy // TypeDefIndex: 6698
{
...
public struct TMP_FontWeightPair // TypeDefIndex: 6700
{
...
public static class TMP_FontUtilities // TypeDefIndex: 6709
{
...
public class TMP_FontAssetUtilities // TypeDefIndex: 6710
{
...
public class TMP_FontFeatureTable // TypeDefIndex: 6711
{
	[SerializeField] 
...
private sealed class TMP_FontFeatureTable.<>c // TypeDefIndex: 6712
{
...
public struct TMP_GlyphValueRecord // TypeDefIndex: 6714
{
	[SerializeField] 
...
public struct TMP_GlyphAdjustmentRecord // TypeDefIndex: 6715
{
	[SerializeField] 
...
public class TMP_GlyphPairAdjustmentRecord // TypeDefIndex: 6716
{
	[SerializeField] 
...
public class TMP_InputField : Selectable, IUpdateSelectedHandler, IEventSystemHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler, ISubmitHandler, ICanvasElement, ILayoutElement, IScrollHandler // TypeDefIndex: 6718
{
...
public enum TMP_InputField.ContentType // TypeDefIndex: 6719
{
	public int value__; 
...
public enum TMP_InputField.InputType // TypeDefIndex: 6720
{
	public int value__; 
...
public enum TMP_InputField.CharacterValidation // TypeDefIndex: 6721
{
	public int value__; 
...
public enum TMP_InputField.LineType // TypeDefIndex: 6722
{
	public int value__; 
...
public sealed class TMP_InputField.OnValidateInput : MulticastDelegate // TypeDefIndex: 6723
{
...
public class TMP_InputField.SubmitEvent : UnityEvent<string> // TypeDefIndex: 6724
{
...
public class TMP_InputField.OnChangeEvent : UnityEvent<string> // TypeDefIndex: 6725
{
...
public class TMP_InputField.SelectionEvent : UnityEvent<string> // TypeDefIndex: 6726
{
...
public class TMP_InputField.TextSelectionEvent : UnityEvent<string, int, int> // TypeDefIndex: 6727
{
...
public class TMP_InputField.TouchScreenKeyboardEvent : UnityEvent<TouchScreenKeyboard.Status> // TypeDefIndex: 6728
{
...
private sealed class TMP_InputField.<CaretBlink>d__267 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 6730
{
...
private sealed class TMP_InputField.<MouseDragOutsideRect>d__285 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 6731
{
	private int <>1__state; 
	private object <>2__current; 
	public TMP_InputField <>4__this; 
...
public abstract class TMP_InputValidator : ScriptableObject // TypeDefIndex: 6733
{
...
public struct TMP_LineInfo // TypeDefIndex: 6734
{
...
internal static class TMP_ListPool<T> // TypeDefIndex: 6735
{
...
private sealed class TMP_ListPool.<>c<T> // TypeDefIndex: 6736
{
...
public static class TMP_MaterialManager // TypeDefIndex: 6737
{
...
private class TMP_MaterialManager.FallbackMaterial // TypeDefIndex: 6738
{
	public int baseID; 
...
private class TMP_MaterialManager.MaskingMaterial // TypeDefIndex: 6739
{
	public Material baseMaterial; 
...
private sealed class TMP_MaterialManager.<>c__DisplayClass10_0 // TypeDefIndex: 6740
{
	public Material stencilMaterial; 
...
private sealed class TMP_MaterialManager.<>c__DisplayClass12_0 // TypeDefIndex: 6741
{
	public Material stencilMaterial; 
...
private sealed class TMP_MaterialManager.<>c__DisplayClass13_0 // TypeDefIndex: 6742
{
	public Material stencilMaterial; 
...
private sealed class TMP_MaterialManager.<>c__DisplayClass14_0 // TypeDefIndex: 6743
{
	public Material baseMaterial; 
...
public struct TMP_MeshInfo // TypeDefIndex: 6745
{
...
internal class TMP_ObjectPool<T> // TypeDefIndex: 6746
{
...
public struct TMP_FontStyleStack // TypeDefIndex: 6747
{
	public byte bold; 
	public byte italic; 
...
public struct TMP_RichTextTagStack<T> // TypeDefIndex: 6748
{
...
public class TMP_ScrollbarEventHandler : MonoBehaviour, IPointerClickHandler, IEventSystemHandler, ISelectHandler, IDeselectHandler // TypeDefIndex: 6753
{
...
public class TMP_SelectionCaret : MaskableGraphic // TypeDefIndex: 6754
{
...
public class TMP_Settings : ScriptableObject // TypeDefIndex: 6755
{
...
public class TMP_Settings.LineBreakingTable // TypeDefIndex: 6756
{
...
public class TMP_SubMesh : MonoBehaviour // TypeDefIndex: 6758
{
	[SerializeField] 
...
public class TMP_SubMeshUI : MaskableGraphic, IClippable, IMaskable, IMaterialModifier // TypeDefIndex: 6759
{
	[SerializeField] 
	private TMP_FontAsset m_fontAsset; 
	[SerializeField] 
...
public enum TMP_TextElementType // TypeDefIndex: 6765
{
	public int value__; 
...
public abstract class TMP_Text : MaskableGraphic // TypeDefIndex: 6772
{
	[SerializeField] 
	[TextAreaAttribute] 
	protected string m_text; 
...
public class TMP_TextElement // TypeDefIndex: 6775
{
	[SerializeField] 
...
public class TMP_TextElement_Legacy // TypeDefIndex: 6776
{
	public int id; 
	public float x; 
	public float y; 
...
public class TMP_TextInfo // TypeDefIndex: 6777
{
...
public class TMP_TextParsingUtilities // TypeDefIndex: 6778
{
...
public static class TMP_TextUtilities // TypeDefIndex: 6781
{
...
private struct TMP_TextUtilities.LineSegment // TypeDefIndex: 6782
{
...
public class TMP_UpdateManager // TypeDefIndex: 6783
{
...
public class TMP_UpdateRegistry // TypeDefIndex: 6784
{
...
public static class TMP_Math // TypeDefIndex: 6789
{
...
public enum TMP_VertexDataUpdateFlags // TypeDefIndex: 6790
{
	public int value__; 
...
public struct TMP_PageInfo // TypeDefIndex: 6792
{
	public int firstCharacterIndex; 
	public int lastCharacterIndex; 
	public float ascender; 
...
public struct TMP_LinkInfo // TypeDefIndex: 6793
{
	public TMP_Text textComponent; 
	public int hashCode; 
...
public struct TMP_WordInfo // TypeDefIndex: 6794
{
	public TMP_Text textComponent; 
	public int firstCharacterIndex; 
	public int lastCharacterIndex; 
...
public struct TMP_SpriteInfo // TypeDefIndex: 6795
{
