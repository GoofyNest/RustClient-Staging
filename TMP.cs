public class TMP_Asset : ScriptableObject // TypeDefIndex: 6744
{
	public int hashCode; 
...
public class TMP_Character : TMP_TextElement // TypeDefIndex: 6745
{
...
public struct TMP_Vertex // TypeDefIndex: 6746
{
...
public struct TMP_CharacterInfo // TypeDefIndex: 6747
{
...
public class TMP_ColorGradient : ScriptableObject // TypeDefIndex: 6749
{
...
public static class TMP_DefaultControls // TypeDefIndex: 6758
{
...
public struct TMP_DefaultControls.Resources // TypeDefIndex: 6759
{
...
public class TMP_FontAsset : TMP_Asset // TypeDefIndex: 6761
{
	[SerializeField] 
...
private sealed class TMP_FontAsset.<>c // TypeDefIndex: 6762
{
...
public class TMP_Glyph : TMP_TextElement_Legacy // TypeDefIndex: 6764
{
...
public struct TMP_FontWeightPair // TypeDefIndex: 6766
{
...
public static class TMP_FontUtilities // TypeDefIndex: 6775
{
...
public class TMP_FontAssetUtilities // TypeDefIndex: 6776
{
...
public class TMP_FontFeatureTable // TypeDefIndex: 6777
{
	[SerializeField] 
...
private sealed class TMP_FontFeatureTable.<>c // TypeDefIndex: 6778
{
...
public struct TMP_GlyphValueRecord // TypeDefIndex: 6780
{
	[SerializeField] 
...
public struct TMP_GlyphAdjustmentRecord // TypeDefIndex: 6781
{
	[SerializeField] 
...
public class TMP_GlyphPairAdjustmentRecord // TypeDefIndex: 6782
{
	[SerializeField] 
...
public class TMP_InputField : Selectable, IUpdateSelectedHandler, IEventSystemHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler, ISubmitHandler, ICanvasElement, ILayoutElement, IScrollHandler // TypeDefIndex: 6784
{
...
public enum TMP_InputField.ContentType // TypeDefIndex: 6785
{
	public int value__; 
...
public enum TMP_InputField.InputType // TypeDefIndex: 6786
{
	public int value__; 
...
public enum TMP_InputField.CharacterValidation // TypeDefIndex: 6787
{
	public int value__; 
...
public enum TMP_InputField.LineType // TypeDefIndex: 6788
{
	public int value__; 
...
public sealed class TMP_InputField.OnValidateInput : MulticastDelegate // TypeDefIndex: 6789
{
...
public class TMP_InputField.SubmitEvent : UnityEvent<string> // TypeDefIndex: 6790
{
...
public class TMP_InputField.OnChangeEvent : UnityEvent<string> // TypeDefIndex: 6791
{
...
public class TMP_InputField.SelectionEvent : UnityEvent<string> // TypeDefIndex: 6792
{
...
public class TMP_InputField.TextSelectionEvent : UnityEvent<string, int, int> // TypeDefIndex: 6793
{
...
public class TMP_InputField.TouchScreenKeyboardEvent : UnityEvent<TouchScreenKeyboard.Status> // TypeDefIndex: 6794
{
...
private sealed class TMP_InputField.<CaretBlink>d__267 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 6796
{
...
private sealed class TMP_InputField.<MouseDragOutsideRect>d__285 : IEnumerator<object>, IEnumerator, IDisposable // TypeDefIndex: 6797
{
	private int <>1__state; 
	private object <>2__current; 
	public TMP_InputField <>4__this; 
...
public abstract class TMP_InputValidator : ScriptableObject // TypeDefIndex: 6799
{
...
public struct TMP_LineInfo // TypeDefIndex: 6800
{
...
internal static class TMP_ListPool<T> // TypeDefIndex: 6801
{
...
private sealed class TMP_ListPool.<>c<T> // TypeDefIndex: 6802
{
...
public static class TMP_MaterialManager // TypeDefIndex: 6803
{
...
private class TMP_MaterialManager.FallbackMaterial // TypeDefIndex: 6804
{
	public int baseID; 
...
private class TMP_MaterialManager.MaskingMaterial // TypeDefIndex: 6805
{
	public Material baseMaterial; 
...
private sealed class TMP_MaterialManager.<>c__DisplayClass10_0 // TypeDefIndex: 6806
{
	public Material stencilMaterial; 
...
private sealed class TMP_MaterialManager.<>c__DisplayClass12_0 // TypeDefIndex: 6807
{
	public Material stencilMaterial; 
...
private sealed class TMP_MaterialManager.<>c__DisplayClass13_0 // TypeDefIndex: 6808
{
	public Material stencilMaterial; 
...
private sealed class TMP_MaterialManager.<>c__DisplayClass14_0 // TypeDefIndex: 6809
{
	public Material baseMaterial; 
...
public struct TMP_MeshInfo // TypeDefIndex: 6811
{
...
internal class TMP_ObjectPool<T> // TypeDefIndex: 6812
{
...
public struct TMP_FontStyleStack // TypeDefIndex: 6813
{
	public byte bold; 
	public byte italic; 
...
public struct TMP_RichTextTagStack<T> // TypeDefIndex: 6814
{
...
public class TMP_ScrollbarEventHandler : MonoBehaviour, IPointerClickHandler, IEventSystemHandler, ISelectHandler, IDeselectHandler // TypeDefIndex: 6819
{
...
public class TMP_SelectionCaret : MaskableGraphic // TypeDefIndex: 6820
{
...
public class TMP_Settings : ScriptableObject // TypeDefIndex: 6821
{
...
public class TMP_Settings.LineBreakingTable // TypeDefIndex: 6822
{
...
public class TMP_SubMesh : MonoBehaviour // TypeDefIndex: 6824
{
	[SerializeField] 
...
public class TMP_SubMeshUI : MaskableGraphic, IClippable, IMaskable, IMaterialModifier // TypeDefIndex: 6825
{
	[SerializeField] 
	private TMP_FontAsset m_fontAsset; 
	[SerializeField] 
...
public enum TMP_TextElementType // TypeDefIndex: 6831
{
	public int value__; 
...
public abstract class TMP_Text : MaskableGraphic // TypeDefIndex: 6838
{
	[SerializeField] 
	[TextAreaAttribute] 
	protected string m_text; 
...
public class TMP_TextElement // TypeDefIndex: 6841
{
	[SerializeField] 
...
public class TMP_TextElement_Legacy // TypeDefIndex: 6842
{
	public int id; 
	public float x; 
	public float y; 
...
public class TMP_TextInfo // TypeDefIndex: 6843
{
...
public class TMP_TextParsingUtilities // TypeDefIndex: 6844
{
...
public static class TMP_TextUtilities // TypeDefIndex: 6847
{
...
private struct TMP_TextUtilities.LineSegment // TypeDefIndex: 6848
{
...
public class TMP_UpdateManager // TypeDefIndex: 6849
{
...
public class TMP_UpdateRegistry // TypeDefIndex: 6850
{
...
public static class TMP_Math // TypeDefIndex: 6855
{
...
public enum TMP_VertexDataUpdateFlags // TypeDefIndex: 6856
{
	public int value__; 
...
public struct TMP_PageInfo // TypeDefIndex: 6858
{
	public int firstCharacterIndex; 
	public int lastCharacterIndex; 
	public float ascender; 
...
public struct TMP_LinkInfo // TypeDefIndex: 6859
{
	public TMP_Text textComponent; 
	public int hashCode; 
...
public struct TMP_WordInfo // TypeDefIndex: 6860
{
	public TMP_Text textComponent; 
	public int firstCharacterIndex; 
	public int lastCharacterIndex; 
...
public struct TMP_SpriteInfo // TypeDefIndex: 6861
{
