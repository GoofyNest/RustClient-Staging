public class ODDCQDDCDD : MonoBehaviour // TypeDefIndex: 7264
{
	...
	public static bool OQOCDCDOQO(List<Vector3> vecs, List<ODDCQDDCDD.OOCOCQCQOQ> edges, int p1, int p2, int p3) { }
...
public class ODDCQDDCDD.OOCOCQCQOQ // TypeDefIndex: 7265
{
	public int start; 
	public int end; 
