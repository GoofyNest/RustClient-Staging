public class PathFinder // TypeDefIndex: 13125
{
	private int[,] costmap; 
	private int[,] visited; 
...
public struct PathFinder.Point : IEquatable<PathFinder.Point> // TypeDefIndex: 13126
{
	public int x; 
	public int y; 
...
public class PathFinder.Node : IMinHeapNode<PathFinder.Node>, ILinkedListNode<PathFinder.Node> // TypeDefIndex: 13127
{
