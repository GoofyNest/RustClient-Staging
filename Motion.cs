...
public class Motion : MonoBehaviour // TypeDefIndex: 8134
{
	[SerializeField] 
	[TooltipAttribute] 
...
public enum Motion.ExposureMode // TypeDefIndex: 8135
{
	public int value__; 
...
public enum Motion.SampleCount // TypeDefIndex: 8136
{
	public int value__; 
...
private enum Motion.DebugMode // TypeDefIndex: 8137
{
	public int value__; 
