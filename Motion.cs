...
public class Motion : MonoBehaviour // TypeDefIndex: 8145
{
	[SerializeField] 
	[TooltipAttribute] 
...
public enum Motion.ExposureMode // TypeDefIndex: 8146
{
	public int value__; 
...
public enum Motion.SampleCount // TypeDefIndex: 8147
{
	public int value__; 
...
private enum Motion.DebugMode // TypeDefIndex: 8148
{
	public int value__; 
