...
public class Motion : MonoBehaviour // TypeDefIndex: 8138
{
	[SerializeField] 
	[TooltipAttribute] 
...
public enum Motion.ExposureMode // TypeDefIndex: 8139
{
	public int value__; 
...
public enum Motion.SampleCount // TypeDefIndex: 8140
{
	public int value__; 
...
private enum Motion.DebugMode // TypeDefIndex: 8141
{
	public int value__; 
