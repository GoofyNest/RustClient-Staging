...
public class Motion : MonoBehaviour // TypeDefIndex: 8143
{
	[SerializeField] 
	[TooltipAttribute] 
...
public enum Motion.ExposureMode // TypeDefIndex: 8144
{
	public int value__; 
...
public enum Motion.SampleCount // TypeDefIndex: 8145
{
	public int value__; 
...
private enum Motion.DebugMode // TypeDefIndex: 8146
{
	public int value__; 
